export default function CardInvite() {
  return (
    <div className="border-2 m-10 flex flex-row h-screen max-h-52 shadow-md justify-between items-center rounded-2xl ">
      <div className="p-5 space-y-3">
        <h2 className="font-bold text-5xl">Jelajah!</h2>
